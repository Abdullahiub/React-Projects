      ...
      >
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-slate-100">
            Aegis Academy System
          </h2>
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
            Sign in to unlock interactive classroom operations
          </p>
        </div>
            ...
            <div className="flex gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-1">
                  How secret keys are managed in Aegis Academy
                </p>
              </div>
            </div>
            <p className="text-xs text-slate-600 dark:text-slate-350 leading-relaxed">
              Standard credentials are fully managed by the <strong>Aegis Administrative Office</strong>. 
