...
function drawLetterhead(doc: jsPDF, title: string) {
  ...
  doc.setFontSize(20);
  doc.text('AEGIS ACADEMY ERP', 14, 20);

  // Subtitle
  doc.setFont('helvetica', 'normal');
  doc.setFontSize(9);
  doc.text('123 Education Boulevard, District-3 | Phone: +1 555-0100', 14, 26);
...
function drawFooter(doc: jsPDF, pageNumber = 1) {
  ...
  doc.setFont('helvetica', 'normal');
  doc.setFontSize(8);
  doc.text('Confidential Academic Record | Aegis Academy Systems', 14, pageHeight - 10);
